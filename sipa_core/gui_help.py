...
class HelpTabsMixin:
    ...
    def show_help(self):
        ...
        notebook.add(tab4, text="⚙️ PARAMÈTRES")
        ...
        notebook.add(tab6, text="ℹ️ INFOS")
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  [6] SÉCURITÉ OPÉRATIONNELLE
     ...
     → Emergency wipe (☢️ Panic Button)

BONNES PRATIQUES DE SÉCURITÉ
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ⚠️  LÉGALITÉ: N'utilisez JAMAIS sans autorisation écrite
  ...
  ✓ Utilisez MODE PERFORMANCE si ralentissement (⚙️ toggle)
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  ❌ Ralentissements?    → Activez Mode Performance (⚙️)

OBTENIR DE L'AIDE
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  → Onglet "🔘 CATÉGORIES" pour détails sur chaque bouton
  → Onglet "📚 TUTORIELS" pour cas d'usage pratiques
  → Onglet "⚙️ PARAMÈTRES" pour configuration avancée
  → Onglet "❓ FAQ" pour questions fréquentes
  → Onglet "🔥 MENACES" pour menaces actuelles détectées
"""
...
7️⃣ ONGLET: 🔗 AVANCÉ
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ⚡ RAPID7 / 🔧 TENABLE / 🎯 QUALYS / 🛡️ DEFENDER
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  🗺️ CARTE RÉSEAU              → Topologie réseau visuelle
  👁️ MONITORING 24/7            → Surveillance continue
  🥷 MODE STEALTH              → Scans furtifs invisibles
  🔍 DÉTECTION ΔCHANGES        → Anomalies réseau
  ⚖️ COMPARAISON SCANS         → Évolution temporelle
  ⏮️ REPLAY SCANS               → Rejouer analyses antérieures
...
Étapes:
  ...
  6. Onglet 🚀 PRO → DÉTECTION ΔCHANGES pour futures comparaisons
...
Étapes:
  1. Onglet 🔐 SÉCURITÉ → BACKDOOR DETECT (cherche accès arrière)
  2. Onglet ⚠️ DÉTECTION → BRUTE FORCE (cherche attaques)
  3. Onglet 🔐 SÉCURITÉ → PERSISTENCE (cherche malware)
  4. Onglet 🌍 RENSEIGNEMENTS → GEO-IP (connexions suspectes)
  5. Onglet 🚀 PRO → FORENSICS (enquête complète)
...
Étapes:
  1. Onglet ⚡ SCANS → SCAN COMPLET (couverture exhaustive)
  2. Onglet 🔐 SÉCURITÉ → SSL/TLS (certificats et chiffrement)
  3. Onglet 🔐 SÉCURITÉ → FIREWALL (règles de segmentation)
  4. Onglet ⚠️ DÉTECTION → BRUTE FORCE (tentatives d'accès)
  5. Onglet 📄 RAPPORTS → CUSTOM (choisir sections)
...
Étapes:
  1. Onglet 🚀 PRO → MONITORING 24/7 (activer)
  2. Onglet 🚀 PRO → NOTIFICATIONS WIN (activer pour alertes)
  3. Onglet 🔘 CATÉGORIES → Sélectionner scan spécifique à menace
  4. Onglet 🚀 PRO → SCREENSHOT (capturer évidences)
  5. Onglet 📄 RAPPORTS → TIMELINE (chronologie)
...
Étapes:
  1. ⚠️ AUTORISATIONS ÉCRITES REQUISES avant de démarrer!
  2. Onglet 🔐 SÉCURITÉ → EXPLOITS (teste failles courantes)
  3. Onglet 🔐 SÉCURITÉ → BACKDOOR DETECT (cherche accès illégaux)
  4. Onglet 🎨 PARAMÈTRES → EXPLOITS AVANCÉS (teste avancés)
  5. Onglet 🚀 PRO → HONEYPOT++ (pièges pour attaquants)
...
Étapes:
  1. Onglet 🚀 PRO → MONITORING 24/7 (activer)
  2. Onglet ⚙️ OUTILS → SCHEDULE (planifier scans)
  3. Onglet 🚀 PRO → NOTIFICATIONS WIN (recevoir alertes)
  4. Onglet 🚀 PRO → CONFIG EMAIL (rapports quotidiens)
...
Étapes:
  1. Onglet 🔐 SÉCURITÉ → SSL/TLS (audit complet certs)
  2. Onglet 🔐 SÉCURITÉ → SSL CHAIN (vérifie chaîne)
  3. Consultez log pour dates d'expiration
  4. Onglet 📄 RAPPORTS → CUSTOM (export pour calendrier)
...
"""
    ...
    def _create_help_tab_settings(self, tab):
        ...
        content = """
╔════════════════════════════════════════════════════════════════════════════╗
║                    ⚙️ PARAMÈTRES AVANCÉS & CONFIGURATION                  ║
╚════════════════════════════════════════════════════════════════════════════╝
...
R: C'est normal et dépend de:
  ...
  Solution: Onglet ⚙️ PARAMÈTRES → augmenter agressivité
...
R: Plusieurs approches:
  • Onglet 🚀 PRO → MODE STEALTH (scans invisibles)
  • Onglet ⚙️ PARAMÈTRES → réduire timing (T0 = furtif)
  • Onglet 🔗 AVANCÉ → configurer PROXY
  • Onglet ⚙️ OUTILS → PROXY ANONYME
...
R: Config complète:
  1. Onglet 🚀 PRO → MONITORING 24/7 (activer)
  2. Onglet ⚙️ OUTILS → SCHEDULE (planifier scans)
  3. Onglet 🚀 PRO → NOTIFICATIONS WIN (alertes pop-up)
...
1️⃣ RANSOMWARE AVANCÉ
  ...
  Détection T-800:
    ✓ Onglet 🔐 SÉCURITÉ → PERSISTENCE (détecte modules de chiffrement)
    ✓ Onglet 🔍 FORENSIQUE (analyse preuves ransomware)
    ✓ Onglet 🚀 PRO → THREAT INTEL (menaces connues)
    ✓ Onglet ⚠️ DÉTECTION → IA ANOMALIES (pattern d'accès suspect)

2️⃣ ZERO-DAY & EXPLOITS NON PATCHÉS
  Cibles principales:
  ...
  Détection T-800:
    ✓ Onglet ⚡ SCANS → VULN SCAN (recherche spécifique)
    ✓ Onglet 🔐 SÉCURITÉ → EXPLOITS (simule attacks)
    ✓ Onglet 🌍 RENSEIGNEMENTS → SHODAN (dispositifs exposés)
    ✓ Onglet 🦠 VIRUSTOTAL (vérification réputations)
...
3️⃣ SUPPLY CHAIN ATTACKS
  ...
  Détection T-800:
    ✓ Onglet 🔐 SÉCURITÉ → SSL/TLS (audit certificats)
    ✓ Onglet ⚙️ OUTILS → PROCESS (analyse dépendances)
    ✓ Onglet 🔍 FORENSIQUE (traçage source paquets)
    ✓ Onglet 📡 RÉSEAU → TRAFIC (détecte communications C2)

4️⃣ ATTAQUES PAR FORCE BRUTE & CREDENTIAL STUFFING
  Protocoles ciblés:
  ...
  Détection T-800:
    ✓ Onglet ⚠️ DÉTECTION → BRUTE FORCE (tentatives échouées)
    ✓ Onglet 🔑 CREDENTIALS (expositions connues)
    ✓ Onglet 📡 RÉSEAU → AUDIT SERVICES (force SSL/TLS)
    ✓ Onglet 🎨 PARAMÈTRES → THRESHOLDS (seuils d'alerte)

5️⃣ BACKDOORS & PERSISTENCE
  Mécanismes courants:
  ...
  Détection T-800:
    ✓ Onglet 🔓 BACKDOOR DETECT (scan dédié)
    ✓ Onglet 👹 ROOTKIT (détecte noyau compromis)
    ✓ Onglet ⚙️ PROCESS (analyse processus système)
    ✓ Onglet 🔍 FORENSIQUE (recherche preuves)

6️⃣ APT & THREAT ACTORS ORGANISÉS
  Groupes principaux:
  ...
  Détection T-800:
    ✓ Onglet 🌍 RENSEIGNEMENTS → OSINT (empreinte)
...
Configuration automatique:
  → Onglet ⚙️ OUTILS → SCHEDULE
  → Onglet 🚀 PRO → MONITORING 24/7
  → Onglet 🚀 PRO → NOTIFICATIONS WIN
"""
        text.insert("1.0", content)
        text.config(state="disabled")
