...
> **Usage légal uniquement.** N'auditez que vos propres systèmes ou des
...
- **Défense & surveillance** — audit de posture (durcissement du poste
 local), monitoring continu, règles de pare-feu, honeypot, mode discret,
 processus, sandbox *(non implémentée : le bouton le signale)*.
...
**Paramètres → Préférences & alertes → Thème sombre / Thème clair.**
...
**Paramètres → Mode discret** modifie réellement les options passées à Nmap :
...
**Analyses → Chaîne de certificats** ouvre une vraie connexion TLS sur le port 443 de
la cible et :
...
La fenêtre **Aide** comporte 7 onglets. Le bouton **Exporter l'aide** écrit
